// Version 1.5.1 d3-geo-zoom - https://github.com/vasturiano/d3-geo-zoom
(function (global, factory) {
  ...
  function onAdd(typename, value, options) {
    return function () {
      console.log('in onAdd of geo zoom');
    ...
    init: function init(nodeEl, state) {
      ...
      function zoomed(ev) {
        ...
        var v1 = versor.cartesian(
            state.projection.rotate(r0).invert(getPointerCoords(ev)),
          ),
