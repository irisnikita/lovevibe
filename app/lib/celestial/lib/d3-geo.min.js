!(function (n, t) {
  ...
  function q(n, t) {
    var r = -1,
      e = n.length;
    for (t.polygonStart(); ++r < e; ) $(n[r], t, 1);
    t.polygonEnd();
  }
  function j(n, t) {
  ...
  var z,
    ...
    K = {
      ...
      polygonStart: function () {
        (Z = new t.Adder()), (K.lineStart = Q), (K.lineEnd = V);
      },
      polygonEnd: function () {
        var n = +Z;
        J.add(n < 0 ? a + n : n),
  ...
  function Rn(n, t) {
    D.push((U = [(O = n), (F = n)])), t < k && (k = t), t > H && (H = t);
  }
  function Cn(n, t) {
    var r = en([n * l, t * l]);
    if (Y) {
      ...
      s ^ (a * I < p && p < a * n)
        ...
        s
          ...
          ? bn(O, n) > bn(O, F) && (F = n)
          : bn(n, F) > bn(O, F) && (O = n);
    } else D.push((U = [(O = n), (F = n)]));
    t < k && (k = t), t > H && (H = t), (Y = r), (I = n);
  }
  function Pn() {
    An.point = Cn;
  }
  function $n() {
    (U[0] = O), (U[1] = F), (An.point = Rn), (Y = null);
  }
  function qn(n, t) {
    if (Y) {
      var r = n - I;
      B.add(f(r) > 180 ? r + (r > 0 ? 360 : -360) : r);
    } else (W = n), (X = t);
    K.point(n, t), Cn(n, t);
  }
  function jn() {
  ...
  var Gn = {
    ...
    lineEnd: Wn,
    polygonStart: function () {
      (Gn.lineStart = Xn), (Gn.lineEnd = Yn);
    },
    polygonEnd: function () {
      (Gn.lineStart = Fn), (Gn.lineEnd = Wn);
    },
  };
  function On(n, t) {
    n *= l;
  ...
  function Yn() {
    Dn(Mn, wn), (Gn.point = On);
  }
  function Bn(n, t) {
    (Mn = n), (wn = t), (n *= l), (t *= l), (Gn.point = Dn);
    var r = h(t);
    (xn = r * h(n)), (_n = r * S(n)), (Nn = S(t)), kn(xn, _n, Nn);
  }
  function Dn(n, t) {
    n *= l;
    var r = h((t *= l)),
  ...
  function Qn(n) {
    return function (t, r) {
      return f((t += n)) > i && (t -= Math.round(t / a) * a), [t, r];
    };
  }
  function Vn(n) {
    var t = Qn(n);
    return (t.invert = Qn(-n)), t;
  }
  function nt(n, t) {
    var r = h(n),
      e = S(n),
  ...
  function tt(n) {
    ...
    return (
      (n = Kn(n[0] * l, n[1] * l, n.length > 2 ? n[2] * l : 0)),
      (t.invert = function (t) {
    ...
    if (
      (n.forEach(function (n) {
        if (!((t = n.length - 1) <= 0)) {
          ...
          if (ot(i, a)) {
            if (!i[2] && !a[2]) {
              for (o.lineStart(), u = 0; u < t; ++u)
                o.point((i = n[u])[0], i[1]);
              return void o.lineEnd();
            }
            a[0] += 2 * r;
          }
          c.push((e = new ut(i, n, null, !0))),
            l.push((e.o = new ut(i, null, e, !1))),
            c.push((e = new ut(a, n, null, !1))),
            l.push((e.o = new ut(a, null, e, !0)));
        }
      }),
      c.length)
    ) {
      for (l.sort(t), ct(c), ct(l), u = 0, a = l.length; u < a; ++u)
        l[u].e = e = !e;
      for (var f, p, s = c[0]; ; ) {
        for (var h = s, g = !0; h.v; ) if ((h = h.n) === s) return;
        (f = h.z), o.lineStart();
        do {
          if (((h.v = h.o.v = !0), h.e)) {
            if (g)
              for (u = 0, a = f.length; u < a; ++u)
                o.point((p = f[u])[0], p[1]);
            else i(h.x, h.n.x, 1, o);
            h = h.n;
          } else {
            if (g)
              for (f = h.p.z, u = f.length - 1; u >= 0; --u)
                o.point((p = f[u])[0], p[1]);
            else i(h.x, h.p.x, -1, o);
            h = h.p;
          }
          (f = (h = h.o).z), (g = !g);
        } while (!h.v);
      ...
      if ((w = (M = n[y]).length))
        for (
          ...
          if (
            ...
            var H = un(g, F);
            ln(H);
            var I = (O ^ (L >= 0) ? -1 : 1) * _(H[2]);
            (f > I || (f === I && (F[0] || F[1]))) &&
              (v += O ^ (L >= 0) ? 1 : -1);
          }
        }
    return (d < -r || (d < r && E < -e)) ^ (1 & v);
  }
  function pt(n, r, e, i) {
    return function (o) {
      var u,
        ...
        h = {
          ...
          polygonEnd: function () {
            (h.point = g), (h.lineStart = v), (h.lineEnd = E), (a = t.merge(a));
            var n = ft(u, i);
            a.length
        ...
        return {
          ...
          point: function (s, h) {
            var g,
              d = [s, h],
              v = a(s, h),
              E = o ? (v ? 0 : p(s, h)) : v ? p(s + (s < 0 ? i : -i), h) : 0;
            if (
              (!t && (l = e = v) && n.lineStart(),
              v !== e && (!(g = c(t, d)) || ot(t, g) || ot(d, g)) && (d[2] = 1),
              v !== e)
            )
              (f = 0),
                v
                  ? (n.lineStart(), (g = c(d, t)), n.point(g[0], g[1]))
                  : ((g = c(t, d)), n.point(g[0], g[1], 2), n.lineEnd()),
                (t = g);
            else if (u && t && o ^ v) {
              var y;
              E & r ||
  ...
  function _t() {
    xt.point = xt.lineEnd = A;
  }
  function Nt(n, t) {
    (Et = n *= l), (yt = S((t *= l))), (St = h(t)), (xt.point = At);
  }
  function At(n, t) {
    n *= l;
    var r = S((t *= l)),
      ...
      a = St * r - yt * e * o,
      c = yt * r + St * e * o;
    vt.add(s(M(u * u + a * a), c)), (Et = n), (yt = r), (St = e);
  }
  function Rt(n) {
    return (vt = new t.Adder()), j(n, xt), +vt;
  }
  var Ct = [null, null],
  ...
  var qt = {
    ...
    jt = {
      ...
      Point: function (n, t) {
        return bt(n.coordinates, t);
      },
      MultiPoint: function (n, t) {
        for (var r = n.coordinates, e = -1, i = r.length; ++e < i; )
          if (bt(r[e], t)) return !0;
        return !1;
      },
      LineString: function (n, t) {
  ...
  function Tt(n, t) {
    return !!ft(n.map(Gt), Ot(t));
  }
  function Gt(n) {
    return (n = n.map(Ot)).pop(), n;
  }
  function Ot(n) {
    return [n[0] * l, n[1] * l];
  }
  ...
  function Ht() {
    ...
    function w() {
      return t
        .range(g(o / y) * y, i, y)
        .map(h)
        .concat(t.range(g(l / S) * S, c, S).map(d))
        .concat(
          t
            .range(g(e / v) * v, n, v)
            .filter(function (n) {
    ...
    return (
      ...
      (M.stepMinor = function (n) {
        return arguments.length ? ((v = +n[0]), (E = +n[1]), M) : [v, E];
      }),
  ...
  var It,
    ...
    Zt = {
      ...
      lineEnd: A,
      polygonStart: function () {
        (Zt.lineStart = Jt), (Zt.lineEnd = Vt);
      },
      polygonEnd: function () {
        (Zt.lineStart = Zt.lineEnd = Zt.point = A),
          Dt.add(f(Ut)),
          (Ut = new t.Adder());
      },
      result: function () {
        var n = Dt / 2;
        return (Dt = new t.Adder()), n;
      },
    };
  function Jt() {
    Zt.point = Kt;
  ...
  function Kt(n, t) {
    (Zt.point = Qt), (It = Xt = n), (Wt = Yt = t);
  }
  function Qt(n, t) {
    Ut.add(Yt * n - Xt * t), (Xt = n), (Yt = t);
  }
  function Vt() {
    Qt(It, Wt);
  }
  ...
  var or,
    ...
    yr = {
      ...
      polygonEnd: function () {
        (yr.point = Sr), (yr.lineStart = mr), (yr.lineEnd = xr);
      },
      result: function () {
        var n = Er
          ? [dr / Er, vr / Er]
          ...
          ? [lr / pr, fr / pr]
          : [NaN, NaN];
        return (lr = fr = pr = sr = hr = gr = dr = vr = Er = 0), n;
      },
    };
  function Sr(n, t) {
    (lr += n), (fr += t), ++pr;
  ...
  var Pr,
    ...
    Lr = {
      ...
      result: function () {
        var n = +br;
        return (br = new t.Adder()), n;
      },
    };
  function Tr(n, t) {
    (Lr.point = Gr), ($r = jr = n), (qr = zr = t);
  }
  function Gr(n, t) {
    (jr -= n), (zr -= t), br.add(M(jr * jr + zr * zr)), (jr = n), (zr = t);
  }
  let Or, kr, Fr, Hr;
  class Ir {
    constructor(n) {
    ...
    point(n, t) {
      switch (this._point) {
        ...
        default:
          if (
            (this._append`M${n},${t}`,
            this._radius !== Fr || this._append !== kr)
          ) {
  ...
  function Vr(n, t) {
    return +t
      ? (function (n, t) {
          function e(i, o, u, a, c, l, p, h, g, d, v, E, y, S) {
            var m = p - i,
              w = h - o,
              x = m * m + w * w;
            if (x > 4 * t && y--) {
              ...
              ((T * T) / x > t ||
                f((m * b + w * L) / x - 0.5) > 0.3 ||
                a * d + c * v + l * E < Qr) &&
                (e(i, o, u, a, c, l, j, z, $, (N /= C), (A /= C), R, y, S),
                S.point(j, z),
                e(j, z, $, N, A, R, p, h, g, d, v, E, y, S));
            }
          }
          return function (t) {
            var r,
              ...
              d = {
                ...
                lineEnd: S,
                polygonStart: function () {
                  t.polygonStart(), (d.lineStart = m);
                },
                polygonEnd: function () {
                  t.polygonEnd(), (d.lineStart = E);
                },
              };
            function v(r, e) {
            ...
            function w() {
              e(f, p, l, s, h, g, i, o, r, u, a, c, Kr, t),
                (d.lineEnd = S),
                S();
            }
            return d;
  ...
  function ee(n) {
    ...
    function j() {
      var n = te(h, 0, 0, x, _, w).apply(null, t(v, E)),
        e = te(h, g - n[0], d - n[1], x, _, w);
      return (
        (r = Kn(y, S, m)), (a = Zn(t, e)), (f = Zn(r, a)), (u = Vr(a, P)), z()
      );
    }
    function z() {
      return (p = s = null), $;
    ...
    return (
      ...
      ($.translate = function (n) {
        return arguments.length ? ((g = +n[0]), (d = +n[1]), j()) : [g, d];
      }),
      ($.center = function (n) {
        return arguments.length
          ? ((v = (n[0] % 360) * l), (E = (n[1] % 360) * l), j())
          : [v * c, E * c];
      }),
      ($.rotate = function (n) {
        return arguments.length
      ...
      ($.angle = function (n) {
        return arguments.length ? ((w = (n % 360) * l), j()) : w * c;
      }),
      ($.reflectX = function (n) {
        return arguments.length ? ((x = n ? -1 : 1), j()) : x < 0;
      }),
      ($.reflectY = function (n) {
        return arguments.length ? ((_ = n ? -1 : 1), j()) : _ < 0;
      }),
      ($.precision = function (n) {
        return arguments.length ? ((u = Vr(a, (P = n * n))), z()) : M(P);
      }),
      ...
      function () {
        return (t = n.apply(this, arguments)), ($.invert = t.invert && q), j();
      }
    );
  }
  function ie(n) {
  ...
  function ue() {
    return ie(oe).scale(155.424).center([0, 33.6442]);
  }
  function ae() {
    return ue()
      .parallels([29.5, 45.5])
  ...
  var fe = ce(function (n) {
    return M(2 / (1 + n));
  });
  fe.invert = le(function (n) {
    return 2 * _(n / 2);
  });
  var pe = ce(function (n) {
    return (n = x(n)) && n / S(n);
  });
  function se(n, t) {
    return [n, E(w((o + t) / 2))];
  ...
  function xe(n, t) {
    var r = _(we * S(t)),
      ...
      i = e * e * e;
    return [
      (n * h(r)) / (we * (ye + 3 * Se * e + i * (7 * me + 9 * Me * e))),
      r * (ye + Se * e + i * (me + Me * e)),
    ];
  }
  function _e(n, t) {
  ...
  (xe.invert = function (n, t) {
    for (
      ...
      ((u =
        (o =
          (i -= r =
            (i * (ye + Se * o + u * (me + Me * o)) - t) /
            (ye + 3 * Se * o + u * (7 * me + 9 * Me * o))) * i) *
        o *
        o),
      !(f(r) < e));
      ++a
    ...
    return [
      (we * n * (ye + 3 * Se * o + u * (7 * me + 9 * Me * o))) / h(i),
      _(S(i) / we),
    ];
  }),
    (_e.invert = le(p)),
    ...
    (n.geoAlbersUsa = function () {
      var n,
        ...
        u,
        a = ae(),
        c = ue().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
        l = ue().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]),
        f = {
          point: function (n, t) {
            u = [n, t];
          },
    ...
    (n.geoArea = function (n) {
      return (J = new t.Adder()), j(n, K), 2 * J;
    }),
    (n.geoAzimuthalEqualArea = function () {
      return re(fe).scale(124.75).clipAngle(179.999);
    }),
    (n.geoAzimuthalEqualAreaRaw = fe),
    (n.geoAzimuthalEquidistant = function () {
      return re(pe).scale(79.4188).clipAngle(179.999);
    }),
    (n.geoAzimuthalEquidistantRaw = pe),
    (n.geoBounds = function (n) {
      var t, r, e, i, o, u, a;
      if (((H = F = -(O = k = 1 / 0)), (D = []), j(n, An), (r = D.length))) {
        for (D.sort(Ln), t = 1, o = [(e = D[0])]; t < r; ++t)
          Tn(e, (i = D[t])[0]) || Tn(e, i[1])
            ? (bn(e[0], i[1]) > bn(e[0], e[1]) && (e[1] = i[1]),
              bn(i[0], e[1]) > bn(e[0], e[1]) && (e[0] = i[0]))
            : o.push((e = i));
        for (u = -1 / 0, t = 0, e = o[(r = o.length - 1)]; t <= r; e = i, ++t)
          (i = o[t]),
            (a = bn(e[1], i[0])) > u && ((u = a), (O = i[0]), (F = e[1]));
      }
      return (
        (D = U = null),
        O === 1 / 0 || k === 1 / 0
    ...
    (n.geoCircle = function () {
      ...
      return (
        (u.center = function (n) {
          return arguments.length
            ? ((r = 'function' == typeof n ? n : Un([+n[0], +n[1]])), u)
            : r;
        }),
        (u.radius = function (n) {
          return arguments.length
            ? ((e = 'function' == typeof n ? n : Un(+n)), u)
            : e;
        }),
        (u.precision = function (n) {
          return arguments.length
            ? ((i = 'function' == typeof n ? n : Un(+n)), u)
            : i;
        }),
        u
      );
    ...
    (n.geoClipExtent = function () {
      ...
      return (r = {
        stream: function (r) {
          return n && t === r ? n : (n = wt(e, i, o, u)((t = r)));
        },
        extent: function (a) {
          return arguments.length
            ? ((e = +a[0][0]),
    ...
    (n.geoClipRectangle = wt),
    (n.geoConicConformal = function () {
      return ie(de).scale(109.5).parallels([30, 30]);
    }),
    (n.geoConicConformalRaw = de),
    (n.geoConicEqualArea = ue),
    (n.geoConicEqualAreaRaw = oe),
    (n.geoConicEquidistant = function () {
      return ie(Ee).scale(131.154).center([0, 13.9389]);
    }),
    (n.geoConicEquidistantRaw = Ee),
    (n.geoContains = function (n, t) {
      return (n && qt.hasOwnProperty(n.type) ? qt[n.type] : zt)(n, t);
    }),
    (n.geoDistance = $t),
    (n.geoEqualEarth = function () {
      return re(xe).scale(177.158);
    }),
    (n.geoEqualEarthRaw = xe),
    (n.geoEquirectangular = function () {
      return re(ve).scale(152.63);
    }),
    (n.geoEquirectangularRaw = ve),
    (n.geoGnomonic = function () {
      return re(_e).scale(144.049).clipAngle(60);
    }),
    (n.geoGnomonicRaw = _e),
    (n.geoGraticule = Ht),
    ...
    (n.geoIdentity = function () {
      ...
      return (
        ...
        (x.postclip = function (n) {
          return arguments.length ? ((M = n), (v = r = e = i = null), w()) : M;
        }),
        ...
        (x.translate = function (n) {
          return arguments.length ? ((f = +n[0]), (p = +n[1]), w()) : [f, p];
        }),
        (x.angle = function (r) {
          return arguments.length
            ? ((t = S((d = (r % 360) * l))), (n = h(d)), w())
            : d * c;
        }),
        (x.reflectX = function (n) {
          return arguments.length ? ((s = n ? -1 : 1), w()) : s < 0;
        }),
        (x.reflectY = function (n) {
          return arguments.length ? ((g = n ? -1 : 1), w()) : g < 0;
        }),
    ...
    (n.geoInterpolate = function (n, t) {
      ...
      return (w.distance = y), w;
    }),
    (n.geoLength = Rt),
    (n.geoMercator = function () {
      return he(se).scale(961 / a);
    }),
    (n.geoMercatorRaw = se),
    (n.geoNaturalEarth1 = function () {
      return re(Ne).scale(175.295);
    }),
    (n.geoNaturalEarth1Raw = Ne),
    (n.geoOrthographic = function () {
      return re(Ae)
        .scale(249.5)
        .clipAngle(90 + r);
    }),
    (n.geoOrthographicRaw = Ae),
    (n.geoPath = function (n, t) {
      ...
      function u(n) {
        return (
          n &&
            ('function' == typeof o && e.pointRadius(+o.apply(this, arguments)),
            j(n, r(e))),
          e.result()
        );
      }
      return (
        (u.area = function (n) {
          return j(n, r(Zt)), Zt.result();
        }),
        (u.measure = function (n) {
          return j(n, r(Lr)), Lr.result();
        }),
        (u.bounds = function (n) {
          return j(n, r(ir)), ir.result();
        }),
        (u.centroid = function (n) {
          return j(n, r(yr)), yr.result();
        }),
        (u.projection = function (t) {
          return arguments.length
            ? ((r = null == t ? ((n = null), Bt) : (n = t).stream), u)
            : n;
        }),
        (u.context = function (n) {
          return arguments.length
            ? ((e = null == n ? ((t = null), new Ir(i)) : new Cr((t = n))),
              'function' != typeof o && e.pointRadius(o),
              u)
            : t;
        }),
        (u.pointRadius = function (n) {
          return arguments.length
            ? ((o = 'function' == typeof n ? n : (e.pointRadius(+n), +n)), u)
            : o;
        }),
        (u.digits = function (n) {
          ...
          return null === t && (e = new Ir(i)), u;
        }),
        u.projection(n).digits(i).context(t)
      );
    }),
    (n.geoProjection = re),
    (n.geoProjectionMutator = ee),
    (n.geoRotation = tt),
    (n.geoStereographic = function () {
      return re(Re).scale(250).clipAngle(142);
    }),
    (n.geoStereographicRaw = Re),
    (n.geoStream = j),
